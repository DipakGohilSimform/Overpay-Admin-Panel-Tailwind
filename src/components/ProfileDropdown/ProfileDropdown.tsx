...
//   return (
//     <div className="relative w-40 rounded-3xl">
//       <div
//         className="flex items-center justify-center gap-2 p-2 bg-white border border-gray-300 cursor-pointer select-none rounded-3xl"
...
//       {isOpen && (
//         <>
//           <div className="absolute right-0 z-10 px-4 py-2 mt-1 bg-white border border-gray-300 rounded-lg w-60">
